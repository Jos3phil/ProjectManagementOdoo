...
class TestPasswordPolicy(TransactionCase):
    ...
    def test_minclasses_invalid(self):## Correctamente inválidado
    ...
    def test_minclasses_only_two_classes(self):
    ...
    def test_minwords_invalid(self):
    ...
    def test_multiple_policies_valid(self):
    ...
    def test_multiple_policies_invalid(self):
    ...
    def test_get_password_policy_all_params(self):
