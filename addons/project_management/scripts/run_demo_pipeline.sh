...
# COMANDO CORREGIDO: Usamos docker compose run para ejecutar python dentro del contenedor 'web'
if docker compose run --rm web python -m unittest /mnt/extra-addons/project_management/tests/test_unit_pure.py; then
...
# COMANDO CORREGIDO: Usamos docker compose run y la ruta absoluta dentro del contenedor
if docker compose run --rm web odoo --test-enable --stop-after-init -d postgres -i project_management --test-file=/mnt/extra-addons/project_management/tests/test_integracion.py; then
...
# COMANDO CORREGIDO: Usamos docker compose exec con la ruta absoluta
...
if [ "$UNIT_PASSED" = true ]; then echo -e "\033[1;32m🟢 Etapa 1: Tests Unitarios Puros... PASARON\033[0m"; else echo -e "\033[1;31m🔴 Etapa 1: Tests Unitarios Puros... FALLARON\033[0m"; fi
if [ "$INTEGRATION_PASSED" = true ]; then echo -e "\033[1;32m🟢 Etapa 2: Tests de Integración... PASARON\033[0m"; else echo -e "\033[1;31m🔴 Etapa 2: Tests de Integración... FALLARON\033[0m"; fi
...
echo -e "\033[1;36m🔵 Etapa 5: Analisis de Rendimiento.......... GENERADO\033[0m"
echo "==================================="
